...
if (isset($_GET['id'])) {
    ...
    // Obter detalhes da encomenda para saber quais produtos estão associados 
    ...
    if ($resultDetalhes) {
        // Percorrer os detalhes da encomenda e atualizar a quantidade de produtos na tabela de produtos
        ...
        // Apagar os registos de detalhes da encomenda e da encomenda
