...
//Seleciona todos campos da tabela "encomendas"->(e) e calcula a soma dos valores da coluna preco_total_produto da tabela
//A "detalhes_encomenda" ->(d) resultado dessas soma é chamado preco_total_encomenda (AS)
