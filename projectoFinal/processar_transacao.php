...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // bind_param serve para evitar sql injections , i de inteiro s de string dos parametros que vai levar
    ...
    if ($stmtEncomenda->execute()) {
        ...
        foreach ($produtos_vendidos as $produto) {
            ...
            $stmtDetalhes = $conexao->prepare($sqlDetalhes);
                // bind_param serve para evitar sql injections , i de inteiro , d de float dos parametros que vai levar
